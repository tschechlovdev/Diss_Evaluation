...
from effens.ConsensusCS import ConsensusCS
from effens.ConsensusCS.ConsensusCS import CC_function_mapping, CC_FUNCTIONS, build_consensus_cs, ConsensusFunction
from effens.EffEnsMKR import MKR
from effens.Utils.Utils import get_type_from_dataset
from effens.EnsOptimizer import EnsembleSelection
from effens.EnsOptimizer.EnsembleOptimizer import EnsembleOptimizer
from effens.EnsOptimizer.cas import Cas
...
class EffEns:
    ...
    def __init__(self, mkr_path=MKR.path_to_mkr, k_range=(2, 100),
                 random_state=0,
        ...
        self.path_to_mkr = Path(mkr_path)
