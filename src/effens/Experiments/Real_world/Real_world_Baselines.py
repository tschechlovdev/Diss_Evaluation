...
from ClusteringCS.ClusteringCS import CONFIG_SPACE_MAPPING, KMEANS_SPACE, DBSCAN_SPACE
from EnsMetaLearning.Helper import get_n_from_real_world_data
...
cs_all = ClusteringCS.ClusteringCS.build_all_algos_space(k_range=k_range)
cs_part = ClusteringCS.ClusteringCS.build_partitional_config_space(k_range=k_range)
